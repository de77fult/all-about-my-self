        ...
        allProjects.forEach(proj => {
            ...
            if (proj.img) {
                ...
                card.addEventListener('click', function(e) {
                    if (e.target.closest('.project-link') || e.target.closest('.status-badge')) {
                        return;
                    }
    ...
    if (addProjectForm) {
        addProjectForm.addEventListener('submit', (e) => {
            ...
            const newProject = {
                ...
                link: link,
                status: status,
                icon: image === 'roblox_map.png' ? 'fas fa-cube' : (image === 'car_game.jpg' ? 'fas fa-gamepad' : 'fas fa-shield-alt')
            };

document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_name: "Mohamed Khater",
            hero_title: "Cyber security & Network",
            hero_desc: "I'm Mohamed Khater, A 14-year-old cybersecurity enthusiast dedicated to learning the fundamentals of ethical hacking, network security, and digital defense. Building skills today to secure the technology of tomorrow."",
            hero_location: "USA",
            btn_projects: "Check My Projects",
            btn_contact: "Social Media",
            btn_youtube: "YouTube Channel",
            about_title: "About Me",
            about_p1: "I am Mohamed Khater, I am a cybersecurity enthusiast and learner focused on building strong defense skills, understanding ethical hacking, and actively participating in open-source security projects. I am passionate about creating content and sharing practical technical solutions to support and connect with the cybersecurity community.",
            ...
            card_ai_title: "Cybersecurirty & Netowork",
            ...
            skill_gamedev: "Cybersecurity",
            skill_map: "Nmap,and another program",
            ...
            exp_list2_1: "The basic in javascript",
            exp_list2_2: "Advanced system integrations and APIs",
            contact_title: "Social Media",
            copyright: "&copy; 2026 Mohamed Khater. All rights reserved.",
        ...
        ar: {
            ...
            hero_greeting_pill: "منور يا عزيزي في دائرتي التقنية",
            hero_name: "معاك محمد خاطر",
            hero_title: "امن سيبراني & شبكات",
            hero_desc: "أنا محمد خاطر، ناشط ومتعلم في مجال الأمن السيبراني بعمر 14 عامًا. ينصب تركيزي واهتمامي الحالي على دراسة وتعمق أساسيات الاختراق الأخلاقي، وأمن الشبكات، وآليات الدفاع الرقمي الشاملة. أسعى من خلال رحلتي التعليمية إلى فهم الثغرات الأمنية وكيفية معالجتها، والمساهمة الفعالة في المشاريع البرمجية مفتوحة المصدر، بالإضافة إلى مشاركة الحلول والخبرات التقنية التي أكتسبها مع مجتمع المطورين والمختصين. أعمل اليوم على بناء وتطوير مهاراتي بجدية، بهدف المساهمة في حماية وتأمين تكنولوجيا الغد وصناعة بيئة رقمية أكثر أمانًا.",
            hero_location: "الولايات المتحدة الأمريكية",
            btn_projects: "اطلع على مشاريعي",
            btn_contact: "تواصل معي",
            btn_youtube: "تابعني على يوتيوب",
            about_title: "نبذة عني",
            about_p1: "أنا محمد خاطر، مهتم بالأمن السيبراني ومتعلم مستقل بعمر 14 عامًا، مكرس لإتقان أساسيات الاختراق الأخلاقي، أمن الشبكات، وآليات الدفاع الرقمي المتقدمة. رحلتي مدفوعة بتركيز عميق على تحديد الثغرات الأمنية، تأمين الأنظمة، والمشاركة النشطة في المشاريع الأمنية مفتوحة المصدر. وبصرف النظر عن التطوير التقني، أنا شغوف بإنشاء المحتوى التعليمي ومشاركة الحلول العملية والواقعية لدعم مجتمع الأمن السيبراني والمطورين العالمي، والتعاون معه، وتقديم قيمة مضافة له.",
            ...
            about_p3: "هدفي هو الاستمرار في التعلم و حمايه الانظمه الحديثة، والمساهمة الفعالة في المجتمع التقني لمساعدة زملائي المطورين على التطور.",
            ...
            skill_py: "بايثون",
            skill_game_logic: "HTML & CSS",
            skill_gamedev: "امن سيبراني",
            skill_map: "بايثون",
            skill_tools: "أدوات التطوير و Git",
            projects_title: "المشاريع والأكواد  التي انجزتها",
            ...
            exp_list1_1: "ممارسة البرمجة عبر بناء برامج وأدوات  مفيدة",
            exp_list1_2: "تعلم أطار العمل الحديث وتكاملات الخوادم والـ APIs",
            exp_list1_3: "التحسين المستمر من خلال المساهمة في المشاريع مفتوحة المصدر",
            exp_date2: "",
            exp_role2: "ما أتعلمه الآن",
            exp_list2_1: "حمايه الانظمه  (Cybersecurity)",
            exp_list2_2: "حمايه تتطبيقات الويب والأنظمة ",
            exp_list2_3: "الشبكات و ال Api ",
            contact_title: "وسائل التواصل الاجتماعي",
            copyright: "&copy; 2026 محمد خاطر. جميع الحقوق محفوظة.",
